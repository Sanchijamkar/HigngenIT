...
const QuestionDetail = () => {
  ...
  useEffect(() => {
    const fetchQuestion = async () => {
      try {
        ...
        console.log('Fetched question data:', data); // Debug log
        setQuestion(data);
      } catch (err) {
        console.error('Error fetching question:', err); // Full error
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-md">
      ...
      {Array.isArray(question.programmingLanguages) && question.programmingLanguages.length > 0 && (
        <div className="mb-4">
